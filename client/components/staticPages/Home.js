    ...
    return(
        <div id="outer-container">
            ...
            <div id="page-wrap" className="wrapper align-center">
                <img src={require('../../images/logo.png')} className='logo' alt="The Advocacy Project logo"></img>
                <h2 className="tag-line1">Your voice. Your rights. Your choice.</h2>
                <img src={require('../../images/people.png')} className='people' alt="line drawing of people's faces"></img>
