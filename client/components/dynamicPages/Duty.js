        ...
        <div id="outer-container">
            ...
            <div id="page-wrap" className="wrapper">
                <div className="progress-bar">
                    <div className="progress-bar--blue100" />
                </div>
                <h1>Duty to provide an Advocate</h1>
                <p>
                    The Care Act puts people in control of their care and
                    support. It gives people the right to be involved. You might
                    be entitled to free support from an advocate to help you to:{' '}
                </p>
                <ul>
                ...
                {displayDuty}
                <a href="../key-rights">
                    Click here for more information on your right to a Care Act
                    advocate{' '}
                </a>
            </div>
